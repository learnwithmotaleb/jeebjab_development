...
class CategoryStatusController extends GetxController {
  ...
  RxString preferredPickupTime = 'Anytime'.obs;
  ...
  void _loadArguments() {
    ...
    if (cat == 'recycle') {
      ...
      itemType.value = 'Recycling';
      itemSubtype.value = 'Plastic & Paper';
      itemPrice.value = 260.0;
      preferredPickupTime.value = 'As Soon As Possible';
      images.value = [
  ...
  void onCancelRequest() => requestStatus.value = RequestStatus.none;
