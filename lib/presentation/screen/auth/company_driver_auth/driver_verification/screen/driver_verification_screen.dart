...
class _DriverVerificationScreenState extends State<DriverVerificationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      canPop: false,
      child: ResponsiveLayout(mobile: _buildMobile(), tablet: _buildTablet()),
    );
  }
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: TimerWidget(onResendCode: controller.resendOtpProcess),
            ),
                  ...
                  Directionality(
                    ...
                    child: PinCodeTextField(
                      ...
                      pinTheme: PinTheme(
                        ...
                        selectedColor: AppColors.primaryColor,
                        inactiveColor: AppColors.greyColor,
                        activeFillColor: AppColors.primaryColor.withValues(
                          alpha: 0.05,
                        ),
                      ),
                      onCompleted: (v) => print("OTP Completed $v"),
