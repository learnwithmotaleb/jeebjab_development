...
//
//   // ─────────────────────────────────────────────────────────────────────────
//   // 📸 PROOF — upload picture as proof dialog
//   // Usage:
//   //   AppAlerts.proof(
//   //     onContinue: () { /* navigate to image picker */ },
//   //   );
//   // ─────────────────────────────────────────────────────────────────────────
//   static void proof({
//     required VoidCallback onContinue,
//     String title = 'Proof',
//     String message = 'Upload Picture As A Proof!',
...
//             SizedBox(height: Dimensions.h(20)),
//
//             AppButton(label: buttonLabel,  height: Dimensions.h(50), borderRadius: 10,   onPressed: () {
//               Get.back();
//               onContinue();
//             }),
//
...
class AppAlerts {
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // 📸 PROOF — upload picture as proof dialog
  // Opens camera to capture proof image
  // Usage:
  //   AppAlerts.proof();
  // ─────────────────────────────────────────────────────────────────────────
  static void proof({
